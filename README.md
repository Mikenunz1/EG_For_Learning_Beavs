...
* **Abstract**: The Educational Game for Learning Beavers is an interactive project designed to teach players about beavers and their habitats through gameplay. Unlike traditional methods, like reading or watching videos, this game aims to reach a broader audience by being an interactive learning environment. Built with the Godot game engine and using GitHub for teamwork, the game will include key features such as save/load options, inventory, player movement, sound effects, minigames and educational content. If time allows, we will also add multiplayer gameplay and NPCs that adapt to player actions. This game is unique compared to other pieces of interactive educational media because of its topic and its execution. This project focuses on beavers because they are essential ecological engineers.  Beavers can fundamentally change their ecosystems in ways that improve water quality, biodiversity, and help reduce climate change.  As such, this project’s goal is to make learning about beavers’ role in wildlife ecosystems both fun and educational.   
